...
public class SubStageSelectUI : MonoBehaviour
{
    ...
    private Dictionary<int, List<int>> stageConnections; // 각 스테이지가 이동할 수 있는 스테이지 목록
    private HashSet<int> clearedStages = new HashSet<int>(); // 클리어한 스테이지 목록
    private int currentStage = 1; // 현재 스테이지 (예제)
    ...
    public void OpenButton()
    {
        ...
        UpdateStageButtons(); // UI 열릴 때 버튼 업데이트
    }
