...
public class SynergyChecker : MonoBehaviour
{
    ...
    {
        PartySynergyCheck();
        synergyDatas = Resources.LoadAll<SynergyData>("Data/SynergyData");
        SynergyPrefabs = Resources.Load<GameObject>("Image/Icon/Synergy");
        SynergyIcon = Resources.LoadAll<Sprite>("Image/Icon");
    }
